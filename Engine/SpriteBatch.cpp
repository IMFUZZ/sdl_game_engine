...
namespace Engine {
	...
	void SpriteBatch::draw(const Sprite& a_sprite) {
		_glyphs.emplace_back(glm::vec4(a_sprite.x, a_sprite.y, a_sprite.width, a_sprite.height), glm::vec4(0.0f, 0.0f, 1.0f, 1.0f), a_sprite.getTexture().id, a_sprite.depth, a_sprite.color);
	}
